...
def detect_prop(path):
    ...
    for color in props.dominant_colors.colors:
        ...
        print(f"Dominant Color: RGB({red}, {green}, {blue}), Pixel Fraction: {color.pixel_fraction}")

        # Exit the loop after processing the first color
        break

    # If no dominant color is found, print "Unknown"
